...
window.Echo.channel('guides-channel').listen('.GuideCreated', function (data) {
  console.log("Entro");
  var guide_count = document.querySelector("#guides_count");
  guide_count.innerHTML = 'Hola';
});
...
window.io = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/build/index.js"); //window.io = io
//window.Pusher = require('pusher-js');

if (typeof window.io !== "undefined") {
  window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__.default({
    broadcaster: 'socket.io',
    host: 'http://127.0.0.1:6001' //transports: ['websocket']
